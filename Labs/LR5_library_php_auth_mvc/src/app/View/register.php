...
<head>
    ...
    <title>Реєстрація — Library Base MVC</title>
...
<section class="page-title">
    <div class="container">
        ...
        <p>Дані обробляються контролером <code>ReaderController::registerPost()</code> і зберігаються у <code>data/users.json</code>.</p>
    </div>
</section>
