...
Упродовж курсу рекомендується вести акуратний Git-репозиторій: осмислені коміти, гілки для кожної ЛР, грамотне злиття. Детальна памʼятка:

> **[`GIT_GUIDE.md`](GIT_GUIDE.md)** — правила оформлення комітів, робота з гілками, merge vs squash, рекомендовані GUI-клієнти (TortoiseGit, Sourcetree, git cola).
